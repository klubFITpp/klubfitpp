...
- **Za kolik**: Zdarma
- **Registrace**: do 30. 9., [zde](https://forms.gle/SdPiHGGfVNcp1sCz5){:target="_blank" rel="noopener noreferrer"}
- **Sraz**: 12:45 na plácku před Národní technickou knihovnou v Dejvicích 
- **Start**: 13:00
- **Konec**: 19:00 na místě předem neurčeném (někde v Dejvicích), pak vyhlášení výsledků
- **Volná definice Dejvic**: Okolí vzdálené až 2.5 km vzdušnou čarou od Národní Technické knihovny v Dejvicích
- **Tématika**: Kdo si hraje, nezlobí
- **Výhry**: merch Dejvické Šifrovačky, FIT++, Studentské Unie ČVUT či FIT ČVUT
- Na šifry z minulého ročníku se můžete podívat [zde](/events/2025/dejvicka-sifrovacka/)
